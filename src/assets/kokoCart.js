$(document).ready(function(){
  ...
  $.ajax({
    ...
    var giftMax =   Math.floor(totalPrice / 7500);
    var giftCounter = 0;
    ...
    if (giftMax < giftCounter) {
      for (var i = 0; i < itemIdContainer.length; i++) {
        var variantId = itemIdContainer[i];
        $.post('/cart/change.js', {
          quantity: 0,
          id: variantId,
        })
